...
namespace Hotelier.DataAccessLayer.Migrations
{
    ...
    [Migration("20241225232112_mig_Booking_city_country")]
    partial class mig_Booking_city_country
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.About", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.Booking", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.Contact", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.Guest", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.Room", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.Service", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.Staff", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.Subscribe", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotelier.EntityLayer.Concrate.AppUser", b =>
                {
                    b.HasOne("Hotelier.EntityLayer.Concrate.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Hotelier.EntityLayer.Concrate.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Hotelier.EntityLayer.Concrate.AppUser", null)
                        .WithMany()
